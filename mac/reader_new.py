...
#                rec.append('{0}\t{1}{2}'.format(cycnum, stepnum, line))
        ...
        with open('../../../Documents/Dahn Lab 2021/Neware Testing/cyc.dat', 'w') as f:
            for l in cyc:
                f.write(l)
        with open('../../../Documents/Dahn Lab 2021/Neware Testing/step.dat', 'w') as f:
            for l in step:
                f.write(l)
        with open('../../../Documents/Dahn Lab 2021/Neware Testing/rec.dat', 'w') as f:
            for l in rec:
                f.write(l)

        self.cyc = pd.read_csv('../../../Documents/Dahn Lab 2021/Neware Testing/cyc.dat', sep='\t+', header=0, engine='python')
        self.step = pd.read_csv('../../../Documents/Dahn Lab 2021/Neware Testing/step.dat', sep='\t+', header=0, engine='python')
        self.rec = pd.read_csv('../../../Documents/Dahn Lab 2021/Neware Testing/rec.dat', sep='\t+', header=0, engine='python')
